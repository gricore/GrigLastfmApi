...
namespace GrigCoreLastfm.Lastfm
{
    public class LastfmParser
    {
        ...
        public void SetObjectPropertiesValues(ref object obj, GXmlInner inner, Session session)
        {
                ...
                try
                {
                    ...
                    else
                    {
                        if (!IsList(gXmlInner)) // Is list, but just properties list
                        {
                            ...
                            SetObjectPropertiesValues(ref propertyObject, gXmlInner, session);
                        ...
                        else // Items list, it's seriusly
                        {
                            ...
                            // foreach
                            foreach (var xmlInner in gXmlInner.Inners)
                            {
                                try
                                {
                                    // create temp item
                                    ...
                                    SetObjectPropertiesValues(ref addedPropertyObject, xmlInner, session);
                                    // Add object to list
        ...
        {
            SetObjectPropertiesValues(ref obj, inner, null);
        }
